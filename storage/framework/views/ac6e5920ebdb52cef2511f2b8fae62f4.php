...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form action="<?php echo e(url('/golongan/' .$row->gol_id)); ?>" method="post">
            ...
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label for="">GOL ID</label>
                <input type="text" name="gol_id" class="form-control" value="<?php echo e($row->gol_id); ?>">
            </div>
            <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quis\quis-pbwl-elsy\resources\views/golongan/edit.blade.php ENDPATH**/ ?>